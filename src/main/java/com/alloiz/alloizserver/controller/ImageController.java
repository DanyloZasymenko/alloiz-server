...
public class ImageController {
    ...
    @PostMapping("/save")
    private ResponseEntity<ImageDto> save(@RequestBody MultipartFile multipartFile) {
        return ResponseEntity.ok(map(imageService.save(multipartFile), ImageDto.class));
    }
